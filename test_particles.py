...
from pbxd import Body, Physics_Engine, Vec2, Lin_Constr, World_Constr
# 2D XPBD Solver
...
bodies.append(Body(10, 5*Vec2.uvec(math.pi/5), Vec2(0, 0), 0, 0, 0, 1))
bodies.append(Body(5, 10*Vec2.uvec(math.pi/5), Vec2(0, 0), 0, 0, 0, 2))
...
constraints.append(World_Constr(bodies[0], Vec2(0,0), Vec2(0, 0), 5, 0))
constraints.append(Lin_Constr(bodies[0], bodies[1], Vec2(0,0), Vec2(0,0), 5, 0))
